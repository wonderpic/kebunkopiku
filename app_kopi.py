...
st.markdown("""
    <div class="kotak-warning-petani">
        ⚠️ **PENTING UNTUK PETANI:** Data kebun Anda tersimpan aman di memori internet HP ini. <b>JANGAN</b> hapus riwayat internet browser Anda agar catatan tidak hilang otomatis.
    </div>
""", unsafe_allow_html=True)
...
# 3. MENU: JADWAL KERJA (URUTAN WAKTU TERDEKAT GLOBAL LINTAS BLOK 100% AMAN)
    ...
    if st.session_state.kebun_data.empty:
        ...
        for tgs in keranjang_tugas_global:
            ...
            with st.container():
                ...
                # Menampilkan rekomendasi agroklimate tipis di atas tugas terkait
