...
# --- 🌟 PUSAT DATA KEBUN PERMANEN (Silakan Ganti/Edit Angka di Sini) 🌟 ---
# Data di bawah ini tidak akan pernah hilang biarpun HP mati atau browser di-refresh!
Daftar_Kebun_Abadi = [
...
# Memaksa tabel selalu terisi data di atas tanpa menggunakan st.session_state
...
# 3. MENU: KALKULATOR PUPUK (PENGHUBUNG KONTAK REAL-TIME)
    ...
    if not df_filter.empty:
        ...
        if wilayah != "Pilih Wilayah...":
            ...
            pesan_wa = f"Halo {toko['nama']}, saya ingin memesan {jenis_barang} sebanyak {tonase:,.1f} Kg untuk kebutuhan blok kebun kopi saya melalui rekomendasi aplikasi Talaga Hangsa KopiPlanPro."
